...
### 2. Ключевые показатели и прогноз денег
...
![Шаг 2 — ключевые показатели и прогноз](./docs/guide/kpi-forecast.png)
...
![Шаг 3 — приоритетные действия](./docs/guide/priority-actions.png)

### 4. Экономика каждого товара
...
![Шаг 4 — экономика товаров с nmID и баркодами](./docs/guide/product-economics.png)

### 5. Потери, возвраты и списания
...
![Шаг 5 — потери, возвраты и списания](./docs/guide/financial-control.png)

### 6. Планирование и уведомления
...
![Шаг 6 — симулятор, уведомления и история](./docs/guide/planning-tools.png)
