...
![Шаг 1 — запуск аудита и паспорт точности](./docs/guide/step-1.png)

![Шаг 2 — ключевые показатели и прогноз](./docs/guide/step-2.png)

![Шаг 3 — приоритетные действия](./docs/guide/step-3.png)

![Шаг 4 — экономика товаров с nmID и баркодами](./docs/guide/step-4.png)

![Шаг 5 — потери, возвраты и списания](./docs/guide/step-5.png)

![Шаг 6 — симулятор, уведомления и история](./docs/guide/step-6.png)
